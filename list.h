/*
	$Id$
	$Log$
	Revision 1.0  2000-03-21 16:06:44+00  jjs
	Initial revision
...
template<class T> class BroadList : public voidList
{
public:

	BroadList(int siz) : voidList(siz)
	{
		;
	}
	...
	BOOL Remove(T obj){return voidList::Remove((void *)obj);}
