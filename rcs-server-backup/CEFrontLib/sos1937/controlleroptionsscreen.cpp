...
// $Log$
// Revision 1.35  2000-07-25 13:48:17+01  jjs
// Fixes for Japanese version DCSSJR02.
//
// Revision 1.34  2000-05-26 10:21:34+01  img
// Overwriting text fixed!
//
...
int ControllerOptionsScreen::ControlPressed(int ControlPacket)
{
	...
	{
		if(SelectedWord != GS_ACCELERATE || !(ControlPacket & ((1 << CON_Y) | (1 << CON_X) | (1 << CON_A) | (1 << CON_B)) ))
