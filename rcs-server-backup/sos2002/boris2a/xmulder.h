...
// $Log$
// Revision 1.1  2000-01-07 16:13:04+00  jjs
// Modified LoadMulderFile to accept bool VB usage.
//
...
void loadMulderFile( char * filename, mesh * meshdata, float scale, char * SSname, bool uniqueTextures, bool UseVB = false);
